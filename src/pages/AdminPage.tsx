...
const SCHICHTTYPEN_FIELDS = [
  ...
  { key: 'beginn_uhrzeit', label: 'Beginn (Uhrzeit)', type: 'string/text' },
  { key: 'ende_uhrzeit', label: 'Ende (Uhrzeit)', type: 'string/text' },
...
const MITARBEITER_FIELDS = [
  ...
  { key: 'verfuegbare_tage', label: 'Verfügbare Wochentage', type: 'multiplelookup/checkbox', options: [{ key: 'dienstag', label: 'Dienstag' }, { key: 'mittwoch', label: 'Mittwoch' }, { key: 'donnerstag', label: 'Donnerstag' }, { key: 'freitag', label: 'Freitag' }, { key: 'samstag', label: 'Samstag' }, { key: 'sonntag', label: 'Sonntag' }, { key: 'montag', label: 'Montag' }] },
...
const SCHICHTPLAN_FIELDS = [
  ...
  { key: 'schicht_auswahl', label: 'Schichttyp', type: 'applookup/select', targetEntity: 'schichttypen', targetAppId: 'SCHICHTTYPEN', displayField: 'kuerzel' },
  { key: 'bereich', label: 'Bereich / Standort', type: 'string/text' },
  { key: 'status', label: 'Status', type: 'lookup/select', options: [{ key: 'geplant', label: 'Geplant' }, { key: 'bestaetigt', label: 'Bestätigt' }, { key: 'abgesagt', label: 'Abgesagt' }, { key: 'offen', label: 'Offen' }] },
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'schichtplan' && fieldKey === 'schicht_auswahl') {
      const match = (lists.schichttypenList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.kuerzel ?? '—';
    }
    return String(url);
  }, [getLookupLists]);
